...
Pytest supports adding custom marks to tests or test parameters for filtering
tests for test runs. For a general introduction to marking tests, refer to the
